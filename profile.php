...
$s_year = substr($val2['start'],0,4);
$s_month = substr($val2['start'],4,2);
$s_date = substr($val2['start'],6,2);
$e_year = substr($val2['end'],0,4);
$e_month = substr($val2['end'],4,2);
$e_date = substr($val2['end'],6,2);
...
<body>
    ...
    <section class="container profile">
        ...
        <div>
            <h3>旅プラン</h3>
            <div class="info">
                <p>目的地</p><p><?= $area[$val2['area']]?></p><p><?= $country[$val2['country']]?></p>
            </div>
            <div class="info">
                <p>時間</p><p><?= $s_year?>　年　<?= $s_month?>　月　<?= $s_date?>　日　から</p>
                <p><?= $e_year?>　年　<?= $e_month?>　月　<?= $e_date?>　日　まで</p>
            </div><br>
            <button class="btn" onclick="document.location='plan_update.php'">変更</button>
        </div><br>
    </section>
</body>
